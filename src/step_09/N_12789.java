package step_09;//도키도키 간식드리미 성공
//시간 제한	메모리 제한	제출	정답	맞힌 사람	정답 비율
//1 초	128 MB	25654	8758	7350	34.033%
//문제
...
// 가슴을 안고 간식을 받기 위해 미리 공지된 장소에 시간 맞춰 도착했다.
// 그런데 이게 무슨 날벼락인가! 그 곳에는 이미 모든 학생들이 모여있었고,
// 승환이는 마지막 번호표를 받게 되었다. 설상가상으로 몇몇 양심에 털이 난 학생들이 새치기를 거듭한 끝에 대기열의 순서마저 엉망이 되고 말았다.
